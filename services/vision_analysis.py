...
class VisionAnalysisService:
    ...
    async def analyze_student_work(
        ...
        text_prompt = f"""
You are looking at an image containing the student's handwritten math solution.
...
1. Transcribe each line written by the student in the image literally. Do NOT correct any errors, signs, or numbers in your transcription. Look only at what is actually written on the paper.
...
4. Do NOT hallucinate correct steps that are not in the student's handwritten image. Look only at what is actually written on the paper.
...
"""
        ...
        system_prompt = (
            ...
            "Analyze the student's handwritten work shown in the image.\n\n"
            ...
            "First literally transcribe what is written in the image line-by-step. Do not correct the student's errors in your transcription.\n"
            "Then determine:\n"
